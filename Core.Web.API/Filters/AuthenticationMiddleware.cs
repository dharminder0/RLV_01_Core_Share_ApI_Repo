...
namespace Core.Web.Api.Filters {
    public class AuthenticationMiddleware {
        ...
        public async Task Invoke(HttpContext context) {
            //var userName = CoreConfigurationManager.AppSettings["ElmahBasicAuth.UserName"];
            var userName = GlobalSettings.ElmahBasicUserName;
            //var password = CoreConfigurationManager.AppSettings["ElmahBasicAuth.Password"];
            var password = GlobalSettings.ElmahBasicUserPassword;
            //var elmah = CoreConfigurationManager.AppSettings["elmah.mvc.route"];
