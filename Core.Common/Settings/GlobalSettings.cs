...
namespace Core.Common.Settings {
    public class GlobalSettings {
        ...
        public static string VindStaticVacancyId => GetString("Vind.StaticVacancyId");

        public static string PushLeadIntegrationLogMethods => GetString("PushLeadIntegrationLogMethods");
        ...
        public static int ArchiveBeforeYear => GetInt("ArchiveDataBeforeYear");
        public static bool ArchiveDataProcessEnabled => GetBool("ArchiveDataProcessEnabled");
        ...
        public static int DeleteOldLogInterval => GetInt("DeleteOldLogInterval");
